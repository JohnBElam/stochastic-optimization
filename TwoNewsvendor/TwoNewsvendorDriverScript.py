...
def Main():
    ...
    for theta_field, theta_central in theta_grid:
        ...
        print(
            f"\nStarting!!!!!  policy_field: {params['policy_field']} with par_field: {theta_field}  - policy_central: {params['policy_central']} with par_central {theta_central}"
        )
        ...
        for ite in range(params["n_Testing_Ite"]):
            ...
            if False:
                print(f"Final Field State {printTuple(M_field.state)}")
